...
class Secret
{
    ...
    public static function saticText()
    {
        return [
            ...
            "minor2"=>["minorCheckbox1"=>"The client is prone to mood swings and self-harming behavior, which makes her hostile toward others. She developed self-harming behavior at an early age, which was brought on by the anxiety she experienced.",
