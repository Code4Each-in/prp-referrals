...
<body>
    ...
    <div class="container mt-5">
                ...
                <form action="functions/submit_form.php" method="post" id="contactForm" novalidate>
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="mb-3 row row-radio">
                                <label class="col-sm-12 col-form-label">Is this is an initial referral or a concurrent
                                    referral?</label>
                                <div class="row row-jhk">
                                    <div class="col-sm-2 form-check mt-2">
                                        ...
                                        <input class="form-check-input" type="radio" id="initial" name="referralType"
                                            value="initial">
                                    </div>
                                </div>
                                <div class="row row-jhk">
                                    <div class="col-sm-4 form-check mt-2">
                                        <label for="concurrent" class="col-sm-8 col-form-label">Concurrent Referral
                                        </label>
                                        <input class="form-check-input" type="radio" id="concurrent" name="referralType"
                                            value="concurrent">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="invalid-feedback">Please enter the Affiliated Referring Organization.
                                    </div>
                                </div>
                            </div>
                            <div class="mb-3 row">
                            ...
                            <div class="mb-3 row row-radio">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2 form-check mt-2">
                                        <input class="form-check-input checkbox-group" type="checkbox" id="service1"
                                            name="services1"
                                            value="housing - assisted living services - 24/7 supervision">
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-sm-2 form-check mt-2">
                                        <input class="form-check-input checkbox-group" type="checkbox" id="service2"
                                            name="services2"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2 form-check mt-2">
                                        <input class="form-check-input checkbox-group" type="checkbox" id="service3"
                                            name="services3" value="psychiatry">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <label for="service4" class="col-sm-8 col-form-label">
                                        ...
                                        management</label>
                                    <div class="col-sm-2 form-check mt-2">
                                        <input class="form-check-input checkbox-group" type="checkbox" id="service4"
                                            name="services4" value="medication management">
                                    </div>
                                </div>
                                <div class="row">
                                    <label for="service5" class="col-sm-8 col-form-label"><i class="fa fa-hand-o-right"
                                        ...
                                        counseling</label>
                                    <div class="col-sm-2 form-check mt-2">
                                        <input class="form-check-input checkbox-group" type="checkbox" id="service5"
                                            name="services5" value="mental health counseling">
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-sm-2 form-check mt-2">
                                        <input class="form-check-input checkbox-group" type="checkbox" id="service6"
                                            name="services6" value="primary care">
                                    </div>
                                </div>
                                    ...
                                    <div class="row row-cols">
                                        <div class="col-sm-4 form-check mt-2">
                                            ...
                                            <input class="form-check-input mt-2" type="radio" id="minorYes"
                                                name="minorAge" value="yes" required>
                                        </div>
                                        <div class="col-sm-8 form-check mt-2">
                                ...
                                <ol class="oreder-listing">
                                            ...
                                            <div class="col-sm-4 form-check">
                                                <div class="row  row-cols">
                                                    <div class="col-sm-4 form-check mt-2">
                                                        ...
                                                        <input class="form-check-input mt-2" type="radio"
                                                            id="disorderYes" name="disorder" value="yes" required>
                                                    </div>
                                                    <div class="col-sm-8 form-check mt-2">
                                    ...
                                    <li>
                                            ...
                                            <div class="col-sm-4 form-check">
                                                <div class="row  row-cols">
                                                    <div class="col-sm-4 form-check mt-2">
                                                        ...
                                                        <input class="form-check-input mt-2" type="radio"
                                                            id="medicationsYes" name="medications" value="yes" required>
                                                    </div>
                                                    <div class="col-sm-3 form-check mt-2">
                                                    ...
                                                    <div class="col-sm-8 form-check mt-2">
                                                        <label for="medicationsNone" class="col-form-label">No
                                                            Medications</label>
                                                        <input class="form-check-input mt-2" type="radio"
                                                            id="medicationsNone" name="medications"
                                                            value="medicationsNone">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <table class="table hidden" id="medicationTable">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                <tr>
                                                    <td> <select class="form-select emptySelect"
                                                            aria-label="Default select example"
                                                            name="medication[<?php echo $i; ?>][name]"
                                                    ...
                                                    <td> <select class="form-select emptySelect"
                                                            aria-label="Default select example"
                                                            name="medication[<?php echo $i; ?>][dosage]"
                                                    ...
                                                    <td> <select class="form-select emptySelect"
                                                            aria-label="Default select example"
                                                            name="medication[<?php echo $i; ?>][frequency]"
                                        ...
                                        <div class="mb-3 row hidden" id="medicationTreatmentDiv">
                                            <label for="medicationTreatment" class="col-sm-5 col-form-label">Why are
                                                ...
                                                <span class="text-danger"> *</span></label>
                                            <div class="col-sm-7">
                                                <textarea class="form-control" id="medicationTreatment" rows="3"
                                        ...
                                        <div class="mb-3 row hidden" id="medicationsNoRadioDiv">
                                            ...
                                            <div class="col-sm-6">
                                                <textarea class="form-control" id="medicationsNoRadio" rows="3"
                                            ...
                                            <div class="col-sm-4 form-check">
                                                <div class="row  row-cols">
                                                    <div class="col-sm-4 form-check mt-2">
                                                        ...
                                                        <input class="form-check-input mt-2" type="radio"
                                                            id="dischargedYes" name="discharged" value="yes" required>
                                                    </div>
                                                    <div class="col-sm-3 form-check mt-2">
                                            ...
                                            <div class="col-sm-4 form-check">
                                                <div class="row  row-cols">
                                                    <div class="col-sm-4 form-check mt-2">
                                                        ...
                                                        <input class="form-check-input mt-2" type="radio"
                                                            id="arrestedYes" name="arrested" value="yes" required>
                                                    </div>
                                                    <div class="col-sm-3 form-check mt-2">
                                            ...
                                            <div class="col-sm-4 form-check">
                                                <div class="row row-cols">
                                                    <div class="col-sm-4 form-check mt-2">
                                                        ...
                                                        <input class="form-check-input mt-2" type="radio"
                                                            id="employedYes" name="employed" value="yes" required>
                                                    </div>
                                                    <div class="col-sm-3 form-check mt-2">
                                                ...
                                                <div class="row row-cols">
                                                    <div class="col-sm-4 form-check mt-2">
                                                        <label for="individualNatureYes"
                                                            class="col-form-label">Yes</label>
                                                        <input class="form-check-input mt-2" type="radio"
                                                            id="individualNatureYes" name="individualNature" value="yes"
                                                            onchange="handleInputChange(this, 'yes')" required>
                                                    </div>
                                                    <div class="col-sm-3 form-check mt-2">
                                                        ...
                                                        <input class="form-check-input mt-2" type="radio"
                                                            ...
                                                            onchange="handleInputChange(this, 'yes')">
                                                    </div>
                                                    <div class="col-sm-5 form-check mt-2">
                                                        ...
                                                        <input class="form-check-input mt-2" type="radio"
                                                            ...
                                                            value="unknown" onchange="handleInputChange(this, 'yes')">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="row  row-cols">
                                                    <div class="col-sm-4 form-check mt-2">
                                                        ...
                                                        <input class="form-check-input mt-2" type="radio"
                                                            ...
                                                            name="individualIntensiveCare" value="yes" required
                                                            onchange="handleInputChange(this, 'no')">
                                                    </div>
                                                    <div class="col-sm-3 form-check mt-2">
                                    ...
                                    <li class="outerRadio">
                                                ...
                                                <div class="row row-cols">
                                                    <div class="col-sm-4 form-check mt-2">
                                                        ...
                                                        <input class="form-check-input mt-2" type="radio"
                                                            ...
                                                            name="individualIntensivelevel" value="yes" required
                                                            onchange="handleInputChange(this, 'yes')">
                                                    </div>
                                                    <div class="col-sm-3 form-check mt-2">
                                        ...
                                        <div class="hidden" id="intenseServicesDiv">
                                            <div class="mb-3 row row-radio">
                                                <label class="col-sm-12 col-form-label">Which of the following less
                                                    intense services have been tried?</label>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-2 form-check mt-2">
                                                        <input class="form-check-input checkbox-group" type="checkbox"
                                                            id="intenseServices1" name="intenseServices[]"
                                                            value="Individual and/or Group Therapy">
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-2 form-check mt-2">
                                                        <input class="form-check-input checkbox-group" type="checkbox"
                                                            id="intenseServices2" name="intenseServices[]"
                                                            value="Targeted Case Management">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row  row-cols">
                                                    ...
                                                    <div class="col-sm-3 form-check mt-2">
                                                        <label for="supportConsideredNo"
                                                            class="col-form-label">No</label>
                                                        <input class="form-check-input mt-2" type="radio"
                                                            id="supportConsideredNo" name="supportConsidered" value="no"
                                                            onchange="handleInputChange(this, 'yes')">
                                                    </div>
                                                    <div class="col-sm-5 form-check mt-2">
                                                ...
                                                <div class="row row-cols">
                                                    <div class="col-sm-4 form-check mt-2">
                                                        ...
                                                        <input class="form-check-input mt-2" type="radio"
                                                            ...
                                                            name="eligibleDisableAdminService" value="yes" required
                                                            onchange="handleInputChange(this, 'no')">
                                                    </div>
                                                    <div class="col-sm-3 form-check mt-2">
                                                ...
                                                <div class="row  row-cols">
                                                    <div class="col-sm-4 form-check mt-2">
                                                        ...
                                                        <input class="form-check-input mt-2" type="radio"
                                                            ...
                                                            name="organicProcessOrSyndrome" value="yes" required
                                                            onchange="handleInputChange(this, 'no')">
                                                    </div>
                                                    <div class="col-sm-3 form-check mt-2">
                                                ...
                                                <div class="row   row-cols">
                                                    ...
                                                    <div class="col-sm-3 form-check mt-2">
                                                        <label for="behavioralControlNo"
                                                            class="col-form-label">No</label>
                                                        <input class="form-check-input mt-2" type="radio"
                                                            id="behavioralControlNo" name="behavioralControl" value="no"
                                                            onchange="handleInputChange(this, 'no')">
                                                    </div>
                                                    <div class="col-sm-5 form-check mt-2">
                                                        ...
                                                        <input class="form-check-input mt-2" type="radio"
                                                            ...
                                                            value="unknown" onchange="handleInputChange(this, 'no')">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="row row-cols">
                                                    ...
                                                    <div class="col-sm-3 form-check mt-2">
                                                        ...
                                                        <input class="form-check-input mt-2" type="radio"
                                                            ...
                                                            value="no" onchange="handleInputChange(this, 'no')">
                                                    </div>
                                                    <div class="col-sm-5 form-check mt-2">
                                    ...
                                    <li class="outerRadio">
                                        <div class="row-list">
                                            ...
                                            <div class="col-sm-8 form-check">
                                                <div class="row row-cols">
                                                    <div class="col-sm-6 form-check mt-2">
                                                        <label for="referralSourceDigital"
                                                            class="col-form-label">IP/Crisis Res/Mobile/ ACT/ RTC/
                                                            Incarceration</label>
                                                        <input class="form-check-input mt-2" type="radio"
                                                            id="referralSourceDigital" name="referralSource"
                                                            value="IP/Crisis Res/Mobile/ ACT/ RTC/ Incarceration"
                                                            required>
                                                    </div>
                                                    <div class="col-sm-3 form-check mt-2">
                                    ...
                                    <li>
                                        ...
                                        <div class="col-sm-7">
                                            <textarea class="form-control" id="reasonForInsufficientTreatment"
                                                name="reasonForInsufficientTreatment"
                                                required><?php echo $saticText['ansOfQuestion21']; ?></textarea>
                    ...
                    <div class="card minorQuestionnaire hidden">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h5>Functional impairment questionnaire (<span class="diagnosisHeadingSpan">
                                            Adult</span>)</h5>
                                </div>
                                <div class="card-body">
                                    <div class="card-body">
        ...
        <button type="button" class="btn btn-outline-primary submit-btn me-4" onclick="refreshPage()"
        ...
        for (var i = 0; i < clientNameOptions.length; i++) {
            if (clientNameOptions[i].value === clientInputValue) {
                ...
                if (matchingClientObjects.length > 0) {
                    ...
                    // SET ADDRESS
                    if (matchingClientObject.client_highest_grade && matchingClientObject
                        .client_highest_grade != null) {
                    ...
                    if (matchingClientObject.current_medication && matchingClientObject.current_medication !=
                        ...
                        } else if (matchingClientObject.current_medication.toLowerCase() ==
                            "no active medications") {
                            $("#medicationsNone").prop('checked', true);
                        }
                    }
                    $('#diagnosis option[data-diagnosisid="' + matchingClientObject.diagnosis_id + '"]').prop(
                        'selected', true);
        ...
        if (minorAgeValue === 'yes') {
            ...
            selectedCheckboxValues.forEach(function(templateId, index) {
                ...
                if (!templateContainer.find(`#template_${templateId}`).length) {
                    var jhfbkljfh = adultQuestionnaireFormHtml(templateId, index, dataValue);
    ...
    function adultQuestionnaireFormHtml(templateId, indexNo, dataValue) {
        var optionsHTML = '';
        $.each(clientIssue, function(index, issue) {
            optionsHTML += '<option value="' + issue.issue + '" data-issueId="' + issue.id + '">' + issue
                .issue + '</option>';
        });
            ...
            success: function(response) {
                ...
                if (responseData.clientNamelyData.length > 0) {
                    $.each(responseData.clientNamelyData, function(index, option) {
                        $('#namely-' + testid).append('<option value="' + option.name +
                            '" data-namelyid="' + option.id + '" data-issueid="' + option
                            .issue_id + '">' + option.name + '</option> ');
                    });
                }

                if (responseData.interventionData.length > 0) {
                    $.each(responseData.interventionData, function(index, option) {
                        $('#intervention-' + testid).append('<option value="' + option.name +
                            '" data-interventionid="' + option.id + '" data-issueid="' + option
                            .issue_id + '">' + option.name + '</option> ');
                    });
                }
                ...
                if (responseData.clientLongTermGoalData.length > 0) {
                    $.each(responseData.clientLongTermGoalData, function(index, option) {
                        $('#clientLongTermGoal-' + testid).append('<option value="' + option.name +
                            '" data-clientlongtermgoalid="' + option.id + '" data-issueid="' +
                            option.issue_id + '">' + option.name + '</option> ');
                    });
                }
                ...
                if (responseData.clientShortTermGoalData.length > 0) {
                    $.each(responseData.clientShortTermGoalData, function(index, option) {
                        $('#clientShortTermGoal-' + testid).append('<option value="' + option.name +
                            '" data-clientshorttermgoalid="' + option.id + '" data-issueid="' +
                            option.issue_id + '">' + option.name + '</option> ');
                    });
                }
                ...
                if (responseData.additionalInformationClientData.length > 0) {
                    $.each(responseData.additionalInformationClientData, function(index, option) {
                        $('#clientAdditionalInformation-' + testid).append('<option value="' +
                            option.name + '" data-clientAdditionalInformationid="' + option.id +
                            '" data-issueid="' + option.issue_id + '">' + option.name +
                            '</option> ');
                    });
                }
                ...
                if (responseData.additionalInformationServiceData.length > 0) {
                    $.each(responseData.additionalInformationServiceData, function(index, option) {
                        $('#serviceAdditionalInformation-' + testid).append('<option value="' +
                            option.name + '" data-serviceAdditionalInformationid="' + option
                            .id + '" data-issueid="' + option.issue_id + '">' + option.name +
                            '</option> ');
                    });
                }
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (responseData.length > 0) {
                    $.each(responseData, function(index, option) {
                        $('#specifically-' + testid).append('<option value="' + option.name +
                            '" data-specificallyid="' + option.id + '">' + option.name +
                            '</option> ');
                    });
                } else {
                    $('#specifically' + testid).empty();
    ...
    function handleClientQuestionnaire(element) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (responseData.length > 0) {
                    $.each(responseData, function(index, option) {
                        $('#specificallyIntervention-' + testid).append('<option value="' + option
                            .name + '" data-specificallyInterventionid="' + option.id + '">' +
                            option.name + '</option> ');
                    });
                } else {
                    $('#specificallyIntervention-' + testid).empty();
    ...
    function clientAgeOnchange(selectedType) {
        ...
        if (selectedType === 'yes') {
            ...
            $.each(adultCheckobox, function(index, item) {
                var createRow = '<div class="row"><label for="functionalImpairment-' + index +
                    '" class="col-sm-8 col-form-label"><p>' + item +
                    '</p></label><div class="col-sm-2 form-check mt-2"><input class="form-check-input functionalImpairment" type="checkbox" id="functionalImpairment-' +
                    index + '" name="functionalImpairment" value="' + index + '" data-value="' + item +
                    '"></div></div>';
                $('#checkboxContainer').append(createRow);
            });
        }
        ...
        $.each(diagnosisArray, function(index, option) {
            $('#diagnosis').append('<option value="' + option.diagnosis_name + '" data-diagnosisid="' + option
                .id + '">' + option.diagnosis_name + '</option>');
        });
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $.each(responseData, function(index, medication) {
                    $('#medicationName' + index + ' option[data-medicationnameid="' + medication
                        .medication_name_id + '"]').prop('selected', true);
                    $('#medicationDosage' + index + ' option[data-medicationdoseid="' + medication
                        .medication_dose_id + '"]').prop('selected', true);
                    $('#medicationFrequency' + index + ' option[data-medicationfrequencyid="' +
                        medication.medication_frequency_id + '"]').prop('selected', true);
                });
            },
            error: function() {
                $('#result').html('Error loading data.');
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $.each(responseData, function(indexOp, option) {
                        optionsHtml += '<option value="' + option.name + '">' + option.name +
                            '</option>';
                    });
    ...
    function updateSymptoms(diagnosisid) {
        $.ajax({
            ...
            success: function(response) {
                ...
                $('.symptom').append(firstOption);
                $.each(responseData, function(index, option) {
                    symtomsHtml += '<option value="' + option.name + '" data-symptom="' + option
                        .id + '">' + option.name + '</option> ';
                    $('.symptom').append('<option value="' + option.name + '" data-symptom="' +
