    ...
    <div class="container mt-5">
        ...
        <div class="row justify-content-center  position: relative;">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3 row row-radio">
                                ...
                                <div class="row row-jhk">
                                    ...
                                    <div class="col-sm-6 form-check mt-2">
                                        <label for="gender6" class="col-sm-8 col-form-label">Additional gender category or
                                    ...
                                    <div class="col-sm-12 form-check mt-2">
                                        <label for="gender7" class="col-sm-8 col-form-label">Choose not to disclose</label>
                            ...
                            <div class="mb-3 row">
                                <label class="col-sm-8 col-form-label">3. To the best of your knowledge does the client
                                    suffer from any communicable diseases (HIV, Hepatitis, TB, MMRV, etc.)?<span class="text-danger"> *</span></label>
                                <div class="col-sm-4 form-check">
                                    <div class="row">
                                        <div class="col-sm-3 form-check mt-2">
                            ...
                            <div id="medicationsYesRadioDiv" class="hidden">
                                <label class="col-sm-8 col-form-label">Are any of the medications prescribed for MDD or Bipolar?</label>
                            ...
                            <div class="mb-3 row hidden" id="medicationTreatmentDiv">
                                <label for="medicationTreatment" class="col-sm-5 col-form-label">Why are medications not part of the treatment?
                                    <span class="text-danger"> *</span></label>
                                <div class="col-sm-7">
                                    <textarea class="form-control" id="medicationTreatment" name="medicationTreatment" required></textarea>
                                </div>
                            </div>
                            <div class="mb-3 row hidden" id="medicationsNoRadioDiv">
                                <label for="medicationsNoRadio" class="col-sm-4 col-form-label">Please explain why the participant is not on medication:</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="medicationsNoRadio" name="medicationsNoRadio">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label class="col-sm-8 col-form-label">5. Has the client within the past year been
                                    discharged from an inpatient psychiatric facility or hospital?<span class="text-danger"> *</span></label>
                                <div class="col-sm-4 form-check">
                                    <div class="row">
                                        <div class="col-sm-3 form-check mt-2">
                            ...
                            <div class="mb-3 row">
                                <label class="col-sm-8 col-form-label">8. Is the client currently employed? <span class="text-danger"> *</span></label>
                                <div class="col-sm-4 form-check">
                                    <div class="row">
                                        <div class="col-sm-3 form-check mt-2">
                            ...
                            <div class="mb-3 row">
                                <label class="col-sm-8 col-form-label">9. Is the client currently receiving mental
                                    health treatment or psychotherapy from a therapist or psychiatrist?<span class="text-danger"> *</span></label>
                                <div class="col-sm-4 form-check">
                                    <div class="row">
                                        <div class="col-sm-3 form-check mt-2">
                            ...
                            <div class="mb-3 row">
                                <label class="col-sm-8 col-form-label">11. Does the nature of the individual’s
                                    ...
                                    maintain) independent living skills to support the individual’s recovery? <span class="text-danger"> *</span></label>
                                <div class="col-sm-4 form-check">
                                    <div class="row">
                                        <div class="col-sm-3 form-check mt-2">
            ...
            <!-- <div class="alert alert-danger alert-dismissible fade show">
                                            ...
                                            <p>
                                            <i class="bi-exclamation-octagon-fill"></i> Answering  "no" or "unknown" to this question automatically disqualifies
                                                ...
                                                your answer and move to the next question.</p>
